...
let a = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite o valor de ${cores.roxo}A:${cores.cinza} `);
let b = readline.questionInt(`Digite o valor de ${cores.vermelho}B:${cores.cinza} `);
