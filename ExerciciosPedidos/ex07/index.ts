...
a = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite o valor de ${cores.amarelo}A: `);
b = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite o valor de ${cores.amarelo}B: `);
c = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite o valor de ${cores.amarelo}C: `);
const Delta = b**2 -4*a*c;
console.log(`${cores.cinza}${estilos.negrito}O valor de Delta é ${cores.verde}${Delta}${cores.limpa}`);