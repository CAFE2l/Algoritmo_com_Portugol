...
let soma = 0;
for(let c = 500; c >= 0; c -=50) {
    soma += c;  // CORREÇÃO: soma o valor de c
    console.log(`${cores.ciano}${estilos.negrito}${estilos.italico}${c}${cores.limpa}`);
}
console.log(`${cores.cinza}Soma total: ${cores.vermelho}${soma}${cores.limpa}`);  // Agora funciona!
