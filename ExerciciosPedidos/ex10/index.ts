...
let dias: number = readline.questionFloat(`Quantos dias vocÊ trabalhou no mês? `);
let valor: number = 25;
let salario: number = dias * valor * 8;
console.log(`O salário do funcionário é de R$${salario}`);