...
let altura, largura: number;
altura = readline.questionFloat(`${estilos.negrito}${cores.cinza}Qual a altura da parede? `);
largura = readline.questionFloat(`Qual a largura da parede? `);

const area = altura * largura;

let tinta = area / 2;

console.log(`A área da parede é de ${cores.verde}${area} ${cores.cinza}e serão necessários ${cores.vermelho}${tinta} ${cores.cinza}Litro de tinta para pintar a parede${cores.limpa}`);