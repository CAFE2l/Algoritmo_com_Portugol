...
const metros = readline.questionFloat(`${cores.cinza}${estilos.negrito}Digite um distância em metros: `);
console.log(`A distância em ${cores.verde}metros${cores.cinza} corresponde a: `);
console.log(`${metros/1000}Km\n`);
console.log(`${metros/100}Hm\n`);
console.log(`${metros/10}Dam\n`);
console.log(`${metros/1}M\n`);
console.log(`${metros*10}dm\n`);
console.log(`${metros*100}cm\n`);
