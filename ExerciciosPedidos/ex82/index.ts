...
function ParOuImpar(num){
    if(num%2 == 0){
        console.log(`${cores.verde}${estilos.negrito}${estilos.italico}${num} é par${cores.cinza}`);
    } else{
        console.log(`${cores.vermelho}${estilos.negrito}${estilos.italico}${num} é impar${cores.cinza}`);
    }
}
