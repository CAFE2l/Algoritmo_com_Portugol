...
function fibonacciSimples(n: number): number[] {
    const sequencia: number[] = [];  // Apenas UM array
    
    // Casos base
    if (n >= 1) sequencia.push(0);
...
// Testando
console.log(`${cores.cinza}${estilos.negrito}Os 15 primeiros numeros da sequencia de fibonacci: `);
console.log(fibonacciSimples(17));