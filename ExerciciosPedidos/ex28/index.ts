...
console.log("=== LOCADORA DE CARROS ===");
let tipoCarro = readline.questionInt(`[1] Carro Popular\n[2] Carro Luxo\nEscolha: `);
let km = readline.questionInt(`Quantos km foram percorridos? `);
let dias = readline.questionInt(`Quantos dias voce ficou com o carro? `);
...
// Cálculo final (feito uma única vez)
const totalDias = dias * precoPorDia;
const totalKm = km * precoPorKm;
const totalFinal = totalDias + totalKm;

console.log("----------------Resumo----------------");
console.log(`Custo pelos dias: R$ ${totalDias.toFixed(2)}`);
console.log(`Custo pela Km:    R$ ${totalKm.toFixed(2)}`);
