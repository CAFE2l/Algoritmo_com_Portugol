...
const dinheiro = readline.questionFloat(`${cores.cinza}${estilos.negrito}Quantos Reais você tem na carteira? `);
let dolar = dinheiro / 3.45;
console.log(`${cores.verde}R$${dinheiro} ${cores.cinza}é equivalente a U$${cores.azul}${dolar.toFixed(2)}${cores.cinza}`);