...
let ano = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite um ano: `);

// Regra completa do ano bissexto
if ((ano % 4 == 0 && ano % 100 != 0) || ano % 400 == 0) {
    console.log(`O ano ${cores.verde}${ano} ${cores.cinza}é ${cores.verde}bissexto${cores.limpa}`);
} else {
    console.log(`${cores.cinza}${estilos.negrito}O ano ${cores.vermelho}${ano} ${cores.cinza}não é ${cores.vermelho}bissexto${cores.limpa}`);
}
