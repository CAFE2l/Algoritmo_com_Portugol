...
// Dados
const frase: string = "ELEIÇÔES 2026";
...
let nascimento: number = readline.questionInt(`${estilos.negrito}${cores.cinza}Qual o seu ano de nascimento? `);
let idade = 2026 - nascimento;

if (idade >= 16) {
    console.log(`Você ${cores.verde}pode ${cores.cinza}votar!`);
} else {
    console.log(`Você ${cores.vermelho}não pode ${cores.cinza}votar!`);
}