...
// Dados
const frase: string = "VAMOS FORMAR UM TRIANGULO";
...
let comprimento1 = readline.questionFloat(`${cores.cinza}${estilos.negrito}Digite o primeiro comprimento do triangulo: `);
let comprimento2 = readline.questionFloat(`Digite o segundo comprimento do triangulo: `);
let comprimento3 = readline.questionFloat(`Digite o terceiro comprimento do triangulo: `);

if (comprimento1 + comprimento2 > comprimento3 && comprimento1 + comprimento3 > comprimento2 && comprimento2 + comprimento3 > comprimento1) {
    console.log(`${cores.verde}Os comprimentos formam um triangulo!${cores.cinza}`);
} else {
    console.log(`${cores.vermelho}Os comprimentos nao formam um triangulo!${cores.cinza}`);
}

if (comprimento1 === comprimento2 && comprimento1 === comprimento3) {
    console.log(`${cores.verde}O triangulo e equilatero!${cores.cinza}`);
} else if (comprimento1 === comprimento2 || comprimento1 === comprimento3 || comprimento2 === comprimento3) {
    console.log(`${cores.verde}O triangulo e isosceles!${cores.cinza}`);
} else {
    console.log(`${cores.verde}O triangulo e escaleno!${cores.cinza}`);
}