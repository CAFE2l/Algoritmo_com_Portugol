...
let nascimento = readline.questionInt(`Digite o ano de nascimento: `);
const idade = 2025 - nascimento;
if(idade == 18){
    console.log(`Você tem ${idade} anos, já pode se alistar!`);
} else{
    console.log(`Você tem ${idade} anos, ainda não pode se alistar!`);
}