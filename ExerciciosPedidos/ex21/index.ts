...
// Dados
const frase: string = "SITUAÇÃO DE UM ALUNO";
...
let largura = readline.questionFloat(`${cores.cinza}${estilos.negrito}Qual a largura do Terreno? `);
let comprimento = readline.questionFloat(`Qual o comprimento do Terreno? `);

const area = largura * comprimento;

if (area < 100) {
    console.log(`Área de ${cores.azul}${area}m². ${cores.cinza}TERRENO POPULAR`);
} else if (area >= 100 && area <= 500) {
    console.log(`Área de ${cores.azul}${area}m². ${cores.cinza}TERRENO MASTER`);
} else {
    console.log(`Área de ${cores.azul}${area}m². ${cores.cinza}TERRENO VIP`);
}