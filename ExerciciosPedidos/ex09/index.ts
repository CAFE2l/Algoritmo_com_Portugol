...
let salario: number = readline.questionFloat(`${cores.cinza}${estilos.negrito}Qual o salário do funcionário? ${cores.verde}R$${cores.limpa}`);
const aumento = salario *(15/100);
const salarioFinal = salario + aumento;
console.log(`${cores.cinza}${estilos.negrito}O novo salário é de ${cores.verde}R$${salarioFinal}`);
console.log(`${cores.cinza}${estilos.negrito}O aumento foi de R$${cores.azul}${aumento}${cores.limpa}`);