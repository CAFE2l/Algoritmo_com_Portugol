...
let a = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite o valor de A: `);
let b = readline.questionInt(`Digite o valor de B: `);

function Maior(){
    if(a > b){
        console.log(`${cores.verde}${a} ${cores.cinza}é maior que ${cores.vermelho}${b}${cores.cinza}`);
    } else if(b > a ){
        console.log(`${cores.verde}${b} ${cores.cinza}é maior que ${cores.vermelho}${a}${cores.cinza}`);
    } else {
        console.log(`${cores.amarelo}${a}${cores.cinza} é igual a ${cores.amarelo}${b}`);
    }
}
