...
let num = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite um número: `);
if (num %2 == 0){
    console.log(`O número ${cores.verde}${estilos.italico}${num} ${cores.cinza}${estilos.negrito}é ${cores.verde}${estilos.italico}par${cores.limpa}`);
} else{
    console.log(`${cores.cinza}${estilos.negrito}O número ${cores.vermelho}${num}${cores.cinza}${estilos.negrito} é ${cores.vermelho}${estilos.italico}impar${cores.limpa}`);
}