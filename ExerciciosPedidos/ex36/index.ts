...
let p = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite o primeiro valor: `);
let f = readline.questionInt(`Digite o segundo valor: `);
let i = readline.questionInt(`Digite o incremento: `);

console.log(`${cores.cinza}${estilos.negrito}Contagem: `);
for (let c = p; c <= f; c+=i){

   console.log(`${cores.azul}${estilos.negrito}${c}${cores.cinza}`);
}


console.log(`${cores.vermelho}Acabou${cores.limpa}`);