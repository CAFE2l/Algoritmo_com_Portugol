...
let borda = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite uma borda para decoração:
    [1] +----======-----+ 
    [2] ~~~~~~::::::~~~~~~
    [3] <<<<<<------>>>>>>
...
function Gerador(texto: string, vezes: number) {
    if(borda == 1){
...
Gerador("teste pra ver se o guanabara é gay", 4);