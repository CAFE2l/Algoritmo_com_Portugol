...
function Maior(a, b, c){
    if(a > b && a > c){
        return console.log(`O ${a} é maior que ${b} e ${c}`);
    } else if(b > a && b> c){
        return console.log(`O ${b} é maior que ${a} e ${c}`);
    } else if(c > a && c > b){
        return console.log(`O ${c} é maior que ${a} e ${c}`)
    } else {
         return console.log(`Os valores são todos iguais`);
    }
}
