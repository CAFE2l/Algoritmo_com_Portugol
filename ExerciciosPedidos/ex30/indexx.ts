...
let salario = readline.questionFloat(`Qual é o seu salário atual?`);
let sexo = readline.question(`Qual é seu sexo? [M/F]`).toUpperCase();
let anos = readline.questionInt(`Há quantos anos você trabalha na empresa? `);
...
} else if (sexo == "F" && anos > 15 && anos <= 20){
    const aumento= salario * (12/100);
    let novoSalario = salario + aumento;
    console.log(`Seu novo salário é de ${novoSalario}`);
    console.log(`Seu aumento foi de ${aumento}`);
 } else if (sexo == "F" && anos > 20){
    const aumento= salario * (23/100);
    let novoSalario = salario + aumento;
    console.log(`Seu novo salário é de ${novoSalario}`);
    console.log(`Seu aumento foi de ${aumento}`);
 } else if (sexo == "M" && anos < 20){
    const aumento= salario * (3/100);
    let novoSalario = salario + aumento;
    console.log(`Seu novo salário é de ${novoSalario}`);
    console.log(`Seu aumento foi de ${aumento}`);
 } else if (sexo == "M" && anos > 20 && anos <= 30){
    const aumento= salario * (13/100);
    let novoSalario = salario + aumento;
    console.log(`Seu novo salário é de ${novoSalario}`);
    console.log(`Seu aumento foi de ${aumento}`);
 } else if (sexo == "M" && anos > 30){
