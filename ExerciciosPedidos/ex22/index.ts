...
let nome = readline.question(`Qual o nome do funcionário? `);
let salario = readline.questionFloat(`Qual o salário de ${nome}? `);
let anos  = readline.questionInt(`Quantos anos ${nome} trabalha na empresa? `);

if (anos <= 3){
    const aumento = salario * 0.03;
    const novoSalario = salario + aumento;
    console.log(`O novo salário do ${nome} é ${novoSalario}`);
