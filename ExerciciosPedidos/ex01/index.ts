...
// Dados
const frase: string = "MEDIA DO ALUNO";
...
let nota1,nota2: number;
nota1 = readline.questionFloat(`${estilos.negrito}${cores.cinza}Digite a primeira nota do aluno:`);
nota2 = readline.questionFloat(`Digite a segunda nota do aluno: `);
const media = (nota1 + nota2)/2;
console.log(`A média do aluno foi ${cores.vermelho}${estilos.italico}${media}${cores.limpa}`);