...
let nome: string[] = ["Mauro", "Ana", "paulo", "Elizeu", "Mario"];
let nota: number[] = [10, 9, 8, 7, 6];

console.log("--------------------------------");
console.log("         Lista de notas       ");
console.log("--------------------------------");

nome.forEach((aluno, indice) => {
    console.log(`${cores.cinza}${estilos.negrito}${aluno} -${cores.verde} Nota: ${nota[indice]}${cores.cinza}`);
});
