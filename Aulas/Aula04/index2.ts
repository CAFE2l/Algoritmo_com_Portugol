...
let n1, n2: number;
n1 = readline.questionInt(`${cores.cinza}Digite o primeiro valor: `);
n2 = readline.questionInt(`${cores.cinza}Digite o segundo valor: `);
const soma = `${cores.cinza}${estilos.negrito}A soma entra ${cores.vermelho}${n1}${cores.cinza} e ${cores.vermelho}${n2} ${cores.cinza}é igual a ${cores.verde}${n1 + n2}${cores.limpa}`;
console.log(soma);