...
// Dados
const frase: string = "OPERADORES ARITMÈTICOS";
...
b = 2;
r = a % b;
console.log(`${estilos.negrito}${cores.cinza}O resultado é igual a ${cores.verde}${r}${cores.limpa}`);