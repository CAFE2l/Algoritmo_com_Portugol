...
while (c<=6){
    let n = readline.questionInt(`${cores.cinza}${estilos.negrito}Digite um valor: `);
    if (n %2 ==0){
        pares += 1;
    } else{
        impares += 1;
...
console.log(`No total foram ${cores.verde}${pares} ${cores.cinza}números pares digitados`);
console.log(`E ${cores.vermelho}${impares} ${cores.cinza}números impares`);
