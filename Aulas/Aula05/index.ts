...
let preco: number;
preco = readline.questionFloat(`${cores.cinza}${estilos.negrito}Qual é o preço? ${cores.verde}R$${cores.cinza}`);
let promo: number = preco * (5/100);
console.log(`O novo preço é de ${cores.verde}${preco - promo}${cores.limpa}`);
